package com.sukrit.parkinglotsystem.config;

import com.sukrit.parkinglotsystem.exceptions.DependencyException;
...
public class ExceptionInterceptor {
  ...
  @ResponseStatus(value = HttpStatus.PRECONDITION_FAILED)
  public ResponseEntity<String> handleInputInvalidDataException(InvalidDataException e) {
